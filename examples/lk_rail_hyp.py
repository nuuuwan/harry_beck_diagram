...
config.extend_line('Kelani Valley', ['Ratnapura', 'Rakwana', 'Embilipitiya', 'Hambantota'], '4SE')
config.add_line('Wilpattu', 'gold', ['Mannar', 'Vellankulam', 'Pooneryn','Jaffna'], '3N')
config.add_line('East Coast', 'olive', ['Trincomalee', 'Vakarai', 'Batticaloa', 'Sammanthurai', 'Akkaraipattu', 'Pottuvil'], '2SE 3S')
